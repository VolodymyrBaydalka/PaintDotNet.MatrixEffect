...
namespace MatrixEffect
{
  public class MatrixEffectConfigDialog : EffectConfigDialog
  {
    ...
    {
      Mask mask = new Mask((int)numericUpDownCC.Value, (int)numericUpDownRC.Value);

      mask.ColumnOffset = (int)numericUpDownCO.Value;
      mask.RowsOffset = (int)numericUpDownRO.Value;
      mask.Components = ColorComponent.None;
